...
$r = mysqli_query($con,$query);
    while ($row = mysqli_fetch_array($r)) {
        ...
        echo "<div class='d1'>
            ...
            <h3 style='padding-left: 4%;color:green;'>Print Speed : <h3>$speed</h3></h3><br><br>
            <h3 style='padding-left: 4%;color:green;'>Resolution : <h3>$resolution</h3></h3><br><br>
            <h3 style='padding-left: 4%;color:green;'>Connectivity : <h3>$connet</h3></h3><br><br>
            <h3 style='padding-left: 4%;color:green;'>Standard Sheet : <h3>$sheet</h3></h3><br><br>
            <h3 style='padding-left: 4%;color:green;'>Description : <h3>$des </h3></h3><br><br>
            ...
            <a class='buy' href='Buy_printer.php?id=$nm'>Buy</a><br><br>
        </div> ";
    }
?>
</form>
