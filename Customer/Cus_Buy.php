...
<div class="dv1">
    ...
    <?php
include("../connection.php");
    $query="SELECT * FROM mobile WHERE mo_name='$a'";
    ...
    while ($row = mysqli_fetch_array($r)) {
        ...
        echo "<div class='d1'>
            ...
            <h3 style='padding-left: 5%;'>Model Name : $nm </h3>
            <h3 style='padding-left: 5%;'>Front Camera : $f_cam </h3>
            <h3 style='padding-left: 5%;'>Back Camera : $b_cam </h3>
            <h3 style='padding-left: 5%;'>Display : $dis </h3>
            <h3 style='padding-left: 5%;'>Ram : $ram</h3>
            <h3 style='padding-left: 5%;'>Description : $des </h3>
            <h3 style='padding-left: 5%;'>Price : $price</h3>  
        </div> ";
    }
?>
...
<?php
    ...
    if(isset($_POST['Button'])){
        ...
        if(mysqli_query($con,$query)){
            echo "Your Product will be delivered In";
        }
    }
?>
