...
<div class="dv1">
    ...
    <?php
include("../connection.php");
    $query="SELECT * FROM  printer WHERE mo_name='$a'";
    ...
    while ($row = mysqli_fetch_array($r)) {
        ...
        echo "<div class='d1'>
            ...
            <h3 style='padding-left: 4%;'>Print Speed : $speed</h3>
            <h3 style='padding-left: 4%;'>Resolution : $resolution</h3>
            <h3 style='padding-left: 4%;'>Connectivity : $connet</h3>
            <h3 style='padding-left: 4%;'>Standard Sheet : $sheet</h3>
            <h3 style='padding-left: 4%;'>Description : $des </h3>
