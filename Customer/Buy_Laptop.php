...
<div class="dv1">
    ...
    <?php
include("../connection.php");
    $query="SELECT * FROM laptop WHERE mo_name='$a'";
    ...
    while ($row = mysqli_fetch_array($r)) {
        ...
        echo "<div class='d1'>
            ...
            <h3 style='padding-left: 4%;'>SSD : $ssd </h3>
            <h3 style='padding-left: 4%;'>Display : $dis </h3>
            <h3 style='padding-left: 4%'>Ram : $ram</h3>
            <h3 style='padding-left: 4%;'>WARRANTY : $war </h3>
            <h3 style='padding-left: 4%;'>Battery : $bat </h3>
