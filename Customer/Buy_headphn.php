...
<div class="dv1">
    ...
    <?php
include("../connection.php");
    $query="SELECT * FROM headphn WHERE mo_name='$a'";
    ...
    while ($row = mysqli_fetch_array($r)) {
        ...
        echo "<div class='d1'>
            ...
            <h3 style='padding-left: 4%;color:green;'>Model Name : $nm </h3>
            <h3 style='padding-left: 4%;color:green;'>Frequency : $fqn </h3>
            <h3 style='padding-left: 4%;color:green;'>Sensitivity : $sntvt </h3>
            <h3 style='padding-left: 4%;color:green;'>Distortion : $dis </h3>
            <h3 style='padding-left: 4%;color:green;'>Operating_voltage: $optn_vltg</h3>
            <h3 style='padding-left: 4%;color:green;'>Price : $price</h3>  
        </div> ";
    }
?>
<form back-ground-color:"gray" action="" method="post" enctype="multipart/form-data">
<label style="margin-left: 42%;" for="quan"> Quantity :</label>
