...
<body  style="background-image: url('Back_images/img1.jpg')">
    ...
    <h1 style="margin-left:30%;color:gold;">You must <a style="color:gold;" href="signup.php">Sign Up </a> or <a style="color:gold;" href="signin.php">Sign in</a> to see our products</h1>
    <div class="dropdown" style="margin-left: 5%;margin-right: 5%;float: left;background-image: url('Back_images/phone.jpg');background-size: 100% 100%;">
        <ul>
                ...
                <ul class="dropdown-content">
                    <li><?php
                        ...
                        while ($row = mysqli_fetch_array($rw)) {
                            $id=$row['brand_name']
                            ?><a href="No_device.php?id=<?php echo $row['brand_name'] ?>">
                            <?php
                                        echo $id;
                                    ?>
                                </a>
    ...
    <div class="dropdown" style="margin-right: 5%;float: right;background-image: url('Back_images/download.jpg');background-size: 100% 100%;">
        <ul>
    ...
    <P style="font-size:26px;color:red;"><a href="Home.php" style="display:inline-block;margin: 60px 0 40px 26%;">PremierGadet</a> Copyright 2022-2022 Angsuman Barua Pritom</P>
</body>
</html>