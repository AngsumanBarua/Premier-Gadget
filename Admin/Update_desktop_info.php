...
if(isset($_POST['Button'])){
    ...
    $query1="SELECT * FROM desktop WHERE mo_name='$a'";
    ...
    if($r1->num_rows>0){
        ...
        if($price<0){
            ...
            $query2 = "update desktop set price =$price,quantity=$quan where mo_name='$a'";
            if(mysqli_query($con,$query2)){
                header("Location:desktop.php?id=$brand_name");
            }
        }
    }
    if($r1->num_rows==0){
