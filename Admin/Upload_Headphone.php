...
<body style="background-color: powderblue;">
    ...
    <div class="dv2">
        ...
        <form back-ground-color:"gray" action="" method="post" enctype="multipart/form-data">
            ...
            <label style="margin-left: 30%;" for="smfc">Frequency  :</label>
            <input type="text" style="margin-bottom: 10px;" id="smfc" name="smmfc" required><br>
            <label style="margin-left: 30%;" for="smbc">Sensitivity :</label>
            <input type="text" style="margin-bottom: 10px;" id="smbc" name="smmbc" required><br>
            <label style="margin-left: 30%;" for="smd">Distortion :</label>
            <input type="text" style="margin-bottom: 10px;" id="smd" name="smmd" required><br>
            <label style="margin-left: 30%;" for="smr">Operating_voltage  :</label>
...
if(isset($_POST['Button'])){
    ...
    $ext=$ext[$c-1];
    $img=$name.".".$ext;
    $query="INSERT INTO headphn(brand_name,mo_name,Frequency,Sensitivity,Distortion,Operating_voltage,img,price,quantity) VALUES('$a','$name','$freqnc','$senctvt','$distn','$optn_vltg','$img','$price','$quan')";
