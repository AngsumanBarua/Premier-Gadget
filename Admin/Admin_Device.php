...
<body style="background-color: powderblue;">
    ...
    <?php echo "<h1 style='text-align:center;margin-top:50px'> Product's of  $a</h1>" ?>
    <form back-ground-color:"gray" action="" method="post" enctype="multipart/form-data">
    <button style="margin-left:40%; margin-top:20px;margin-bottom:20px;font-size: 15px;background-color: blue; width :20%; padding: 5px;" name="Button1">ADD NEW DEVICE</button><br>
    <?php
        if(isset($_POST['Button1'])){
            header('Location:Upload_Device.php?dev='.$a);
        }
    ?>
    </form>
<?php
include("connection.php");
    ...
    while ($row = mysqli_fetch_array($r)) {
        ...
        <h3 style='padding-left: 4%;color:green;'>Front Camera : <h3 style='color:blue;'>$f_cam </h3></h3><br><br>
        <h3 style='padding-left: 4%;color:green;'>Back Camera : <h3 style='color:blue;'>$b_cam </h3></h3><br><br>
        ...
        ?><a class="updt" href="Update_info.php?id=<?php echo $nm ?>">UPDATE</a><?php
    }
?>  
</body>
</html>