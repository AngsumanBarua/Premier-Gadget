...
if(isset($_POST['Button'])){
    ...
    $query1="SELECT * FROM mobile WHERE mo_name='$a'";
    ...
    if($r1->num_rows>0){
        ...
        if($price<0){
            ...
            $query2 = "update mobile set price =$price,quantity=$quan where mo_name='$a'";
            if(mysqli_query($con,$query2)){
                echo "<p style='color: green;'> Updated";
                header("Location:Admin_device.php?id=$brand_name");
            }
        }
    }
    if($r1->num_rows==0){
        echo "<h1>No Device found </h1>";
    }
}
?>
</body>
