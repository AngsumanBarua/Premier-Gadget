...
<body style="background-color: powderblue;">
    ...
    <button style="margin-left:40%; margin-top:40px;margin-bottom:20px;font-size: 15px;background-color: blue; width :20%; padding: 5px;" name="Button1">ADD NEW DEVICE</button><br>
    <?php
        if(isset($_POST['Button1'])){
            header('Location:Upload_headphone.php?dev='.$a);
        }
    ?>
    </form>
    <form back-ground-color:"gray" action="" method="post" enctype="multipart/form-data">
    ...
    $r = mysqli_query($con,$query);
        while ($row = mysqli_fetch_array($r)) {
            ...
            echo "<div class='d1'>
                ...
                <h3 style='padding-left: 4%;color:green;'>Frequency : <h3 style='color:blue;'>$fqn </h3></h3><br><br>
                <h3 style='padding-left: 4%;color:green;'>Sensitivity : <h3 style='color:blue;'>$sntvt </h3></h3><br><br>
                <h3 style='padding-left: 4%;color:green;'>Distortion : <h3 style='color:blue;'>$dis </h3></h3><br><br>
                <h3 style='padding-left: 4%;color:green;'>Operating_voltage: <h3 style='color:blue;'>$optn_vltg</h3></h3><br><br>
            ...
            ?><a class="updt" href="update_headphone_info.php?id=<?php echo $nm ?>">UPDATE</a><?php
        }
?> 
</form>
</body>
