...
<body style="background-color: powderblue;">
    <div class="dv1">
        ...
        <a href="#" style="float:right;margin-top: 16px;font-size: 25px">ADMIN|</a>
    </div><br>
    <div class="dv2">
        <?php 
...
if(isset($_POST['Button'])){
    ...
    $query1="SELECT * FROM headphn WHERE mo_name='$a'";
    ...
    if($r1->num_rows>0){
        ...
        if($price<0){
            ...
            $query2 = "update headphn set price =$price,quantity=$quan where mo_name='$a'";
            if(mysqli_query($con,$query2)){
                header("Location:Headphone.php?id=$brand_name");
